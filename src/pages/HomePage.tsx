    ...
    <div className="min-h-[100dvh] bg-slate-50 relative overflow-hidden flex flex-col">
      ...
      <header className="px-6 py-5 flex justify-between items-center max-w-7xl mx-auto w-full relative z-40 mt-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={handleSignOut} className="p-2 rounded-full transition-colors bg-white/20 border border-white/30 text-white hover:bg-white hover:text-[#E74B4D]" title="Uitloggen">
