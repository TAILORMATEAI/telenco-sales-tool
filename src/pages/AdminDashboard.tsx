      ...
      <aside className="w-full sm:w-64 bg-white border-b sm:border-r border-slate-200 flex flex-col justify-between shrink-0 sm:h-full relative z-30 shadow-sm sm:shadow-none sm:overflow-y-auto">
        <div className="flex flex-col h-full">
          ...
          <nav className="p-3 sm:p-4 flex sm:flex-col flex-row gap-1.5 overflow-x-auto sm:overflow-visible flex-1">
            ...
            <button onClick={() => navigate('/')} className="sm:hidden flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl font-bold text-sm transition-all whitespace-nowrap shrink-0 text-slate-500 hover:text-slate-500 hover:bg-slate-50">
          ...
          <div className="flex flex-col border-t border-slate-100 bg-slate-50/50 shrink-0">
            ...
            <div className="hidden sm:block p-4 pb-0">
              <button onClick={() => navigate('/')} className="flex items-center justify-center gap-3 px-3 py-2.5 rounded-xl text-slate-500 hover:text-slate-500 hover:bg-slate-100 font-bold text-sm transition-all shrink-0 w-full mb-2 border border-slate-200/50 bg-white shadow-sm">
